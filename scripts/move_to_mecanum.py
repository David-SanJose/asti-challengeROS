...
if __name__ == '__main__':
    try:
        ...
        WHEEL_SEPARATION_WIDTH = rospy.get_param("/wheel/separation/horizontal", 2)
        WHEEL_SEPARATION_LENGTH = rospy.get_param("/wheel/separation/vertical", 2)
        WHEEL_GEOMETRY = (WHEEL_SEPARATION_WIDTH + WHEEL_SEPARATION_LENGTH) / 2
        WHEEL_RADIUS = rospy.get_param("/wheel/diameter", 2) / 2
        ...
        sub = rospy.Subscriber('turtle1/cmd_vel', Twist, convert)
        rospy.spin()
